module.exports = {
    ...
    mongo: {
        url: 'mongodb://localhost:27017/test2' || process.env.MONGO_URL,
    },
    ...
    keys: {
        ...
        POLONIEX: {
            apiKey: 'WXVOIJVV-SLRKFA0B-XAZX8089-VSTUEHJ1' || process.env.POLONIEX_KEY,
            secret: 'da7a6a112f47b37fbef7f0dc2e59217ad8a5c20a95379f9b7cea358befccf585a5ab48af2253b6accb67083bb5224bce3a1b2b360dde3187e95293bd79e5bc99' || process.env.POLONIEX_SEC,
        },
        BINANCE: {
